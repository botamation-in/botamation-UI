                ...
                <div className="grid grid-cols-7">
                    {weekDays.map((date, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`min-h-[50px] border-b border-r border-gray-200 p-1.5 transition-all duration-200 cursor-pointer group relative ${hasAppointments
                            ...
                            >
                                <div className="flex items-start justify-between h-full">
                                    <div className="flex flex-col h-full">
                                        <span
                                            className={`text-xs font-semibold mb-1 transition-colors ${isTodayDate
                                        ...
                                        {renderAppointmentBadge(appointments.length)}
                                    </div>
                                </div>
                                {hasAppointments && (
