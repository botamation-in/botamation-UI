...
export const Header = forwardRef(function Header(
  { variant = 'light', scrolled = false, split = false, className = '', children, ...rest },
  ref
) {
  const classes = [
    'ds-header',
...
export function HeaderStart({ className = '', children, ...rest }) {
  return <div className={['ds-header__start', className].filter(Boolean).join(' ')} {...rest}>{children}</div>;
}

export function HeaderCenter({ className = '', children, ...rest }) {
  return <div className={['ds-header__center', className].filter(Boolean).join(' ')} {...rest}>{children}</div>;
}

export function HeaderEnd({ className = '', children, ...rest }) {
  return <div className={['ds-header__end', className].filter(Boolean).join(' ')} {...rest}>{children}</div>;
}
