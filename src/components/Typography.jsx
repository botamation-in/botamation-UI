...
export function Display({ as: Tag = 'h1', className = '', children, ...rest }) {
  return <Tag className={['ds-display', className].filter(Boolean).join(' ')} {...rest}>{children}</Tag>;
}

export function H1({ className = '', children, ...rest }) {
  return <h1 className={['ds-h1', className].filter(Boolean).join(' ')} {...rest}>{children}</h1>;
}

export function H2({ className = '', children, ...rest }) {
  return <h2 className={['ds-h2', className].filter(Boolean).join(' ')} {...rest}>{children}</h2>;
}

export function H3({ className = '', children, ...rest }) {
  return <h3 className={['ds-h3', className].filter(Boolean).join(' ')} {...rest}>{children}</h3>;
}

export function H4({ className = '', children, ...rest }) {
  return <h4 className={['ds-h4', className].filter(Boolean).join(' ')} {...rest}>{children}</h4>;
}

export function H5({ className = '', children, ...rest }) {
  return <h5 className={['ds-h5', className].filter(Boolean).join(' ')} {...rest}>{children}</h5>;
}

export function H6({ className = '', children, ...rest }) {
  return <h6 className={['ds-h6', className].filter(Boolean).join(' ')} {...rest}>{children}</h6>;
}

/**
 * Heading – polymorphic heading.
 * level: 1–6
 */
export function Heading({ level = 1, className = '', children, ...rest }) {
  const Tag = `h${level}`;
  return <Tag className={[`ds-h${level}`, className].filter(Boolean).join(' ')} {...rest}>{children}</Tag>;
}

export function Subheading({ as: Tag = 'p', className = '', children, ...rest }) {
  return <Tag className={['ds-subheading', className].filter(Boolean).join(' ')} {...rest}>{children}</Tag>;
}
...
export function Text({ size = 'base', className = '', as: Tag = 'p', children, ...rest }) {
  ...
  return <Tag className={[cls, className].filter(Boolean).join(' ')} {...rest}>{children}</Tag>;
}
...
export function Caption({ as: Tag = 'p', className = '', children, ...rest }) {
  return <Tag className={['ds-caption', className].filter(Boolean).join(' ')} {...rest}>{children}</Tag>;
}

/** Overline – tiny all-caps eyebrow */
export function Overline({ as: Tag = 'p', className = '', children, ...rest }) {
  return <Tag className={['ds-overline', className].filter(Boolean).join(' ')} {...rest}>{children}</Tag>;
}

/** Code – inline code snippet */
export function Code({ className = '', children, ...rest }) {
  return <code className={['ds-code', className].filter(Boolean).join(' ')} {...rest}>{children}</code>;
}
